...
\begin{document}
    ...
    \section{Profil}
        ...
        \begin{onecolentry}
Ingénieur d’État intéressé par SAP S/4HANA, au profil technique, je conçois et intègre des processus métiers tout en développant des extensions techniques fiables. À la recherche d’un poste pour contribuer à des projets concrets.
\end{onecolentry}
