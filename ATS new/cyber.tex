...
\begin{document}
    ...
    \section{Profil}
        ...
        \begin{onecolentry}
Ingénieur d’État en cybersécurité, je conçois et protège des infrastructures cloud et sur site, avec une expérience en détection des vulnérabilités, sécurisation des systèmes et automatisation des processus.
À la recherche d’un poste pour contribuer à des projets concrets. \end{onecolentry}
    ...
    \section{Compétences}
    \textbf{Programmation \& Données :} Python, Go, Bash, PowerShell • SQL, Elasticsearch




\begin{onecolentry}
    \textbf{Normes \& Méthodologies :} OWASP Top10, CIS Benchmarks, ISO 27001, GDPR
\end{onecolentry}


\begin{onecolentry}
    \textbf{Offensive / Tests d'intrusion :} Nmap, Metasploit, Burp Suite, sqlmap, Nessus, OpenVAS, Hydra, Wireshark
\end{onecolentry}
