...
\begin{document}
    ...
    \section{Profil}
        ...
        \begin{onecolentry}
           Ingénieur d’État en data engineering et développement full-stack. Expérience pratique dans la conception de pipelines de données robustes, le développement d’applications web et le déploiement sur des environnements cloud. Je cherche à intégrer une équipe où je pourrai concevoir des systèmes fiables, optimiser leur performance et élargir mon expertise à travers des projets complexes et exigeants.
