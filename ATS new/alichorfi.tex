...
\begin{document}
    ...
    \section{Profil}
        ...
        \begin{onecolentry}
Ingénieur d’État spécialisé en ingénierie des données, je construis des pipelines fiables et j’automatise les flux pour transformer les données en informations utiles.
Je conçois des systèmes qui aident les équipes à travailler plus efficacement et à prendre de meilleures décisions.
