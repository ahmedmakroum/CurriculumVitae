...
\usepackage[top=0.50cm, bottom=0.05cm, left=0.25cm, right=0.25cm]{geometry}
\usepackage{ragged2e}
\usepackage{multicol}
\usepackage{enumitem}
\usepackage{amssymb}
...
\item Intégration de sources fragmentées dans un entrepôt PostgreSQL, consolidant plusieurs flux métiers.
