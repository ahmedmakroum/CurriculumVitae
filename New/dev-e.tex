...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/ahmed-makroum/}{linkedin.com/in/ahmed-makroum}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
    ...
    \begin{onecolentry}
        ...
        \item There are 7 unique entry types: \textit{BulletEntry}, \textit{TextEntry}, \textit{Edu     tionEntry}, \textit{ExperienceEntry}, \textit{NormalEntry}, \textit{PublicationEntry}, and \textit{OneLineEntry}.
