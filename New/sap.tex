...
\begin{document}
    ...
    \section{Profil}
        ...
        \begin{onecolentry}
Ingénieur d’État en solutions SAP S/4HANA, profil technico-fonctionnel. Expérience dans la conception et l’intégration de processus métiers, le développement d’extensions techniques et le déploiement sur des environnements cloud. Je cherche à rejoindre une équipe où je pourrai concevoir des systèmes fiables, optimiser leur performance et renforcer mon expertise à travers des projets complexes et exigeants.
    ...
    \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Conception de plans d’infrastructure data pour des clients sur GCP, AWS et des systèmes internes, facilitant la mise en place et l’uniformité des projets.  
...
\begin{onecolentry}
\textbf{Technologies \& Plateformes :} SAP S/4HANA, Fiori/UI5, SAP BTP, BW/4HANA, Datasphere • Intégration (OData, APIs, IDoc) • Cloud (SAP Cloud, AWS, GCP) • Docker, Linux, CI/CD
\end{onecolentry}
        \end{onecolentry}
