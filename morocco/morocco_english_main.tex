...
\begin{itemize}[leftmargin=0.3cm, itemsep=-2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    \item \textbf{Enriched News Pipeline}: Multi-source scraping orchestrated with Airflow, streaming transformation with Kafka, LLM enrichment (summaries + validation), Prometheus monitoring, Cassandra storage. (Python, Kafka, LLM API, Airflow, Cassandra)
