...
\vspace{-6pt}
Ingénieur MIAGE spécialisé en data engineering et développement full-stack. Je conçois des pipelines de données robustes, des applications web efficaces et j’intègre des solutions cloud ouvertes. Je cherche un environnement où je peux résoudre des problèmes concrets, améliorer l’existant et livrer des systèmes utiles.
% EXPÉRIENCE
\vspace{-15pt}
