  ...
  \begin{itemize}[leftmargin=0.3cm, itemsep=-2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
      \item \textbf{Pipeline d’Actualités Enrichies} : Scraping multi-sources orchestré avec Airflow, transformation en stream avec Kafka, enrichissement LLM (résumés + validation), monitoring Prometheus, stockage Cassandra. (Python, Kafka, API llm, Airflow, Cassandra)
